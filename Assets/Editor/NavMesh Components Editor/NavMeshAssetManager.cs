...
namespace UnityEditor.AI
{
    public class NavMeshAssetManager : ScriptableSingleton<NavMeshAssetManager>
    {
        ...
        private static string GetAndEnsureTargetPath(NavMeshSurface surface)
        {
            ...
            {
                targetPath = "Assets/Prefabs/NavMesh Data";
            }
            else
            {
        ...
        {
            string combinedAssetPath = Path.Combine(GetAndEnsureTargetPath(surface), surface.name + ".asset");
        ...
        private bool IsCurrentPrefabNavMeshDataStored(NavMeshSurface surface)
        {
            ...
            foreach (SavedPrefabNavMeshData storedAssetInfo in m_PrefabNavMeshDataAssets.Where(storedAssetInfo => storedAssetInfo.surface == surface))
            {
