...
namespace UnityEditor.AI
{
    ...
    internal class NavMeshSurfaceEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            System.Collections.Generic.List<NavMeshAssetManager.AsyncBakeOperation> bakeOperations = NavMeshAssetManager.instance.GetBakeOperations();
...
#pragma warning disable IDE0051 // 删除未使用的私有成员
        private static void RenderBoxGizmoSelected(NavMeshSurface navSurface, GizmoType gizmoType) => RenderBoxGizmo(navSurface, gizmoType, true);
...
#pragma warning restore IDE0051 // 删除未使用的私有成员
        ...
        private static void RenderBoxGizmo(NavMeshSurface navSurface, GizmoType _, bool selected)
        {
