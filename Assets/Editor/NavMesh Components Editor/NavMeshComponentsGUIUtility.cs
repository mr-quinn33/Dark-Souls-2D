...
namespace UnityEditor.AI
{
    public static class NavMeshComponentsGUIUtility
    {
        ...
        public static void AgentMaskPopup(string labelName, SerializedProperty agentMask)
        {
            ...
            string popupContent = agentMask.hasMultipleDifferentValues ? "\u2014" : GetAgentMaskLabelName(agentMask);
        ...
        private static bool IsAll(SerializedProperty agentMask) => agentMask.arraySize == 1 && agentMask.GetArrayElementAtIndex(0).intValue == -1;
